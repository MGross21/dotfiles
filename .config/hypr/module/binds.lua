...
for i = 1, 10 do
    ...
    hl.bind(mainMod .. " + RCTRL + " .. key, hl.dsp.window.move({ workspace = i, silent = true }))
end
...
hl.bind(mainMod .. " + SHIFT + right", hl.dsp.window.resize({ amount = "20 0" }))
hl.bind(mainMod .. " + SHIFT + left", hl.dsp.window.resize({ amount = "-20 0" }))
hl.bind(mainMod .. " + SHIFT + up", hl.dsp.window.resize({ amount = "0 -20" }))
hl.bind(mainMod .. " + SHIFT + down", hl.dsp.window.resize({ amount = "0 20" }))
